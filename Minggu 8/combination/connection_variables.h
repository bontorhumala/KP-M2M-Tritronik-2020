...
unsigned char bytes[4]; // simpan IP address ketika terhubung ke internet
char sendtext[100]; // text dsiplay berhasil connect dan local ip
bool isWebSocketConnected = true;
uint8_t c_num; //client number passed from websocket event
